...
<div class="ml-[-100%] fixed z-10 top-0 pb-3 px-2 w-full shadow-md flex flex-col justify-between h-screen border-r text-gray-700 bg-gray-100 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    ...
    <div class="w-full px-2">
        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-300"> 
          <a class="{{ Route::is('admin.dashboard') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
              ...
              <a class="{{ Route::is('users.userdata') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
              ...
              <a class="{{ Route::is('books.bookdata') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-300 rounded"
              ...
              <a class="{{ Route::is('peminjaman.peminjaman') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" 
        ...
        <div class="flex flex-col items-center w-full mt-2 border-t border-gray-300"> 
          <a class="{{ Route::is('kategori.kategoridata') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('kategori.kategoridata') }}"> 
          ...
          <a class="{{ Route::is('admin.ulasan') ? 'bg-gray-400 rounded' : '' }} flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('admin.ulasan') }}"> 
