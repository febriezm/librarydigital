        ...
        <a class="flex items-center justify-center px-5 w-64 h-16 mt-auto rounded-md bg-red-500 hover:bg-red-400"
          ...
          <div class="h-full ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            ...
            <div class="flex px-7 mt-2 items-center justify-between">
                <h2 class="font-bold text-xl">Edit Book's</h2>
    
                <form action="{{ route('petugas.destroy', $books) }}" method="post"
            ...
            <div class="mt-4 px-7" x-data="{ imageUrl: '/storage/{{ $books->foto }}' }">
                <form enctype="multipart/form-data" action="{{ route('petugas.update', $books) }}" method="post"
                    class="flex gap-8">
                    @method('put')
                    @csrf
                    ...
                    <div class="w-1/2">
                        ...
                        <div class="mb-5">
                            ...
                            <button
                                ...
                                <a class="flex justify-center mt-3 mb-10 tracking-wide hover:shadow-form border border-green-500 w-full rounded-md bg-gray-100 hover:bg-gray-200 py-3 px-8 text-base font-semibold text-black outline-black" href="{{ route('petugas.buku') }}">
                                    Back
                                </a>
